...
print(f'Image support set+training overlap: {len(ss_images.intersection(train_images))}')
print(f'Audio support set+training overlap: {len(ss_wavs.intersection(train_audio))}')
